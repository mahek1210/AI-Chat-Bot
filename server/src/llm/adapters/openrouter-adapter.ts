...
export class OpenRouterAdapter implements LLMAdapter {
  ...
  private mapModelName(model: string): string {
    ...
    const modelMap: Record<string, string> = {
      ...
      'openrouter:qwen/qwen3-next-80b-a3b-instruct:free': 'qwen/qwen3-next-80b-a3b-instruct:free',
      'openrouter:google/gemma-3n-e2b-it:free': 'google/gemma-3n-e2b-it:free',
      'openrouter:nousresearch/hermes-3-llama-3.1-405b:free': 'nousresearch/hermes-3-llama-3.1-405b:free',
      'openrouter:arcee-ai/maestro-reasoning': 'arcee-ai/maestro-reasoning',
      'openrouter:mistralai/mistral-small-3.1-24b-instruct:free': 'mistralai/mistral-small-3.1-24b-instruct:free',
    };
